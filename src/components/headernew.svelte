<script>
    ...
    import slikaozadnjecomp2 from "../assets/SPLETNA_GRAFIKA_OZADJE_siroko 1 - Copy-min-min.webp";
    import slikatestcomp2 from "../assets/SPLETNA_GRAFIKA_OZADJE_siroko 1 - Copy.webp"
    ...
    <div class="container">
        <div class="papak" style="background-image: url('{slikaozadnjecomp2}'); ">
            <div class="header">
                ...
                <div class="spacer" />
                <a href="https://www.instagram.com/magnadogsworldwide/"
                    ><img class="iglink" src={linkig} alt="tt" /></a
                >
            </div>

            <div class="title">
                <span class="napis">The Sauce</span>
                <div id="crta" />
                <span class="napis">The Movie</span>
            </div>
        </div>
    </div>
</div>
